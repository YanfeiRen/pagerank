...
function threaded_benchmark(graphfile::AbstractString)
    ...
    benchmarks["power_multi"] = benchmark_method_multi(maxtime, setup_call_simple_power_multi, gdata, alpha, SVector((1:8)...))
    ...
    benchmarks["gs_multi"] = benchmark_method_multi(maxtime, setup_call_gs_multi, gdata, alpha, SVector((1:8)...))

    println("Benchmarking fast_gauss")
    benchmarks["gs_multi_zero"] = benchmark_method_multi(maxtime, setup_call_gs_multi_from_zero, gdata, alpha, SVector((1:8)...))
    ...
    benchmarks["push_multi"] = benchmark_method_multi(maxtime, setup_call_multi_push_method, gdata, alpha, SVector((1:8)...))
    ...
    setup_call_cyclic_multi_push_method
    benchmarks["push_cyclic_multi"] = benchmark_method_multi(maxtime, setup_call_cyclic_multi_push_method, gdata, alpha, SVector((1:8)...))
