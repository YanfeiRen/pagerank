...
function distributed_benchmark(graphfile::AbstractString, nprocs, maxtime::Float64=14.4*60)
    ...
    println("Benchmarking sor_from_zero 8")
    benchmarks["sor_from_zero_8"] = benchmark_method_distributed(nprocs, maxtime, setup_call_sor_from_zero, gdata, alpha, vex8)
    println(benchmarks["sor_from_zero_8"])

    println("Benchmarking sor_from_zero2 8")
    benchmarks["sor_from_zero2_8"] = benchmark_method_distributed(nprocs, maxtime, setup_call_sor_from_zero2, gdata, alpha, vex8)
    println(benchmarks["sor_from_zero2_8"])
